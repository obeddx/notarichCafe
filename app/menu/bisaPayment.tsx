//sudah bisa muncul menu yang dipesan, qty, dan harga
"use client";
...
export default function MenuPage() {
  ...
  // Fungsi untuk menampilkan modal pilihan pembayaran (tidak langsung membuat order)
  ...
  // Handler untuk menutup order summary (untuk pembayaran tunai)
      ...
      <div className="bg-white p-6 rounded-lg w-full max-w-md">
        ...
        <button
          onClick={async () => {
            ...
            // Untuk tunai, langsung buat order dan tampilkan order summary
        ...
        <button
          onClick={async () => {
            ...
            setShowPaymentMethodModal(false);
            // Untuk e-wallet, panggil endpoint generate snap token terlebih dahulu
            // const payload = {
              ...
              if (data.success && data.snapToken) {
                ...
                if (window.snap) {
                  window.snap.pay(data.snapToken, {
                    ...
                    onClose: () =>
                      console.log("Popup pembayaran ditutup tanpa menyelesaikan pembayaran"),
                  });
                } else {
  ...
  // Modal: Order Summary untuk opsi Tunai
