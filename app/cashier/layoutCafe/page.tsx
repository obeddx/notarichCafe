...
const Bookinge = () => {
  ...
  const getTableColor = (nomorMeja: number) => {
    const tableOrders = allOrders.filter((order) => order.tableNumber === nomorMeja.toString());
  ...
  const OrderCard = ({ order, isCompleted, onComplete }: { order: Order; isCompleted?: boolean; onComplete?: () => void }) => (
